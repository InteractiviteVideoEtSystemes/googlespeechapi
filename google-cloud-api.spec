...
%{__cp} %{_sourcedir}/Makefile.libgoogleapis googleapis-%{googleapis_commit_id}/

%build
cd %{_builddir}/googleapis-%{googleapis_commit_id}/
. /opt/rh/devtoolset-7/enable
make GRPCPLUGIN=/opt/google/bin/grpc_cpp_plugin PROTOINCLUDE=/opt/google/include
...
%clean
rm -rf $RPM_SOURCE_DIR/googleapis
